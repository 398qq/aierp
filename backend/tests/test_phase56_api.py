...
class TestApprovals:
    ...
    async def test_list_rules_empty(self, async_client: AsyncClient, auth_headers: dict):
    ...
    async def test_create_rule_invalid_doc_type(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.post(
            "/api/v1/approvals/rules",
            headers=admin_headers,
    ...
    async def test_delete_rule(self, async_client: AsyncClient, admin_headers: dict):
        ...
        rid = c.json()["data"]["id"]
        resp = await async_client.delete(f"/api/v1/approvals/rules/{rid}", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_list_requests_empty(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get("/api/v1/approvals/requests", headers=auth_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_list_requests_with_filter(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get(
            "/api/v1/approvals/requests?status=pending&doc_type=quotation", headers=auth_headers
        )
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_rule_requires_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.post(
            "/api/v1/approvals/rules",
...
class TestPermissions:
    ...
    async def test_list_roles_admin(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/permissions/roles", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_list_roles_requires_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get("/api/v1/permissions/roles", headers=auth_headers)
        assert resp.status_code == 403

    async def test_list_audit_logs(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/permissions/audit-logs", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0
...
class TestFinanceAccounts:
    ...
    async def test_create_account_invalid_type(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.post(
            "/api/v1/finance/accounts",
            headers=admin_headers,
    ...
    async def test_account_requires_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get("/api/v1/finance/accounts", headers=auth_headers)
        assert resp.status_code == 403

    async def test_create_journal_entry_balanced(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.post(
    ...
    async def test_create_journal_entry_unbalanced(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.post(
            "/api/v1/finance/journal-entries",
            headers=admin_headers,
            json={
    ...
    async def test_list_journal_entries(self, async_client: AsyncClient, admin_headers: dict):
        ...
        resp = await async_client.get("/api/v1/finance/journal-entries", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0
    ...
    async def test_ap_report(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/finance/reports/ap", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_account_crud_lifecycle(self, async_client: AsyncClient, admin_headers: dict):
        # Create
        c = await async_client.post(
            "/api/v1/finance/accounts",
            headers=admin_headers,
        ...
        # Delete
        d = await async_client.delete(f"/api/v1/finance/accounts/{aid}", headers=admin_headers)
...
class TestNotifications:
    ...
    async def test_list_templates_admin(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/notifications/templates", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_templates_require_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get("/api/v1/notifications/templates", headers=auth_headers)
        assert resp.status_code == 403

    async def test_preferences_crud(self, async_client: AsyncClient, auth_headers: dict):
        # Get empty
        resp = await async_client.get("/api/v1/notifications/preferences", headers=auth_headers)
        assert resp.status_code == 200
        # Save
        resp = await async_client.put(
            ...
            headers=auth_headers,
            json={"preferences": [
                {"event_type": "order_created", "channel": "in_app", "enabled": True},
            ]},
        )
        assert resp.status_code == 200
        assert resp.json()["code"] == 0
...
class TestProcurement:
    ...
    async def test_restock_suggest(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/ai/procurement/restock-suggest", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_restock_requires_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get("/api/v1/ai/procurement/restock-suggest", headers=auth_headers)
        assert resp.status_code == 403
...
class TestReports:
    ...
    async def test_report_inventory(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/reports/predefined/inventory", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_report_procurement(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get(
            "/api/v1/reports/predefined/procurement?year=2025&month=1", headers=admin_headers
        )
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_report_ar(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/reports/predefined/ar", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_reports_require_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.get(
    ...
    async def test_list_templates(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/reports/templates", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0
...
class TestIntegrations:
    ...
    async def test_list_configs_empty(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.get("/api/v1/integrations/configs", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0
    ...
    async def test_create_config(self, async_client: AsyncClient, admin_headers: dict):
        resp = await async_client.post(
            ...
            headers=admin_headers,
            json={
                "type": "ecommerce", "name": "Taobao Store",
                "api_key": "key123", "api_secret": "secret456",
                "endpoint": "https://api.taobao.com", "enabled": False,
            },
        )
        assert resp.status_code == 201
        assert resp.json()["code"] == 0
    ...
    async def test_delete_config(self, async_client: AsyncClient, admin_headers: dict):
        ...
        cid = c.json()["data"]["id"]
        resp = await async_client.delete(f"/api/v1/integrations/configs/{cid}", headers=admin_headers)
        assert resp.status_code == 200
        assert resp.json()["code"] == 0

    async def test_configs_require_permission(self, async_client: AsyncClient, auth_headers: dict):
        resp = await async_client.post(
            "/api/v1/integrations/configs",
            headers=auth_headers,
    ...
    async def test_webhook_receive(self, async_client: AsyncClient):
        resp = await async_client.post(
            "/api/v1/integrations/webhook/taobao",
