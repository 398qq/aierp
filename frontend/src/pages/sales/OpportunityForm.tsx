...
export default function OpportunityForm() {
  ...
  const isEdit = !!id;
  const watchedAmount = ProForm.useWatch("amount", form) as number | undefined;
  const watchedWin = ProForm.useWatch("win_probability", form) as number | undefined;
  const watchedStage = ProForm.useWatch("stage", form) as string | undefined;
        ...
        >
          <Space direction="vertical" size={12} style={{ width: "100%" }}>
            <Card size="small" title="客户与需求">
              ...
              <ProForm.Item name="description" label="需求描述">
            ...
            <Card size="small" title="金额与推进">
              ...
              >
                <ProForm.Item name="amount" label="预计金额">
                  <InputNumber min={0} precision={2} prefix="¥" style={{ width: "100%" }} />
                </ProForm.Item>
                <ProForm.Item name="expected_close_date" label="预计成交日期">
              ...
              <ProForm.Item name="win_probability" label="赢单概率">
            ...
            <Card size="small" title="负责人和下一步">
              ...
              >
                <ProForm.Item name="assigned_to" label="负责人">
          ...
          >
            <Card size="small" title="管道摘要">
              <Space direction="vertical" size={12} style={{ width: "100%" }}>
                ...
                <Space wrap>
                  <StatusTag tone="info">
                    {stageLabel[watchedStage || "lead"] || watchedStage || "线索"}
                  </StatusTag>
                  <StatusTag tone={Number(watchedWin || 0) >= 50 ? "success" : "warning"}>
                    赢率 {Number(watchedWin || 0)}%
                  </StatusTag>
            ...
            <Card size="small">
              <Space direction="vertical" size={8} style={{ width: "100%" }}>
                ...
                <Button block onClick={() => navigate("/sales/opportunities")}>
                  取消
                </Button>
