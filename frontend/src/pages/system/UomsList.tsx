...
import { App, Button, Space, Modal, InputNumber, Card } from "antd";
import {
  ProForm,
  ProFormDigit,
  ProFormSelect,
...
const uomTypeOptions = [
  { label: "计数单位", value: "count" },
  { label: "包装单位", value: "package" },
];
    ...
    <Card title="计量单位管理" extra={<Button type="primary" icon={<PlusOutlined />} onClick={openCreate}>新增单位</Button>}>
      ...
      >
        <ProForm form={form} layout="vertical" submitter={false} style={{ marginTop: 16 }}>
          ...
          />
          <ProFormText name="category" label="分类" placeholder="如 count / reel / box" />
